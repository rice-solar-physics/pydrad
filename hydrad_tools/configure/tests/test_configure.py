...
>>>>>>> d32767723906aadaf44ace82949986d7dbc99c62
...
Configuration file generated by hydrad_tools on {c.date}"""
    ...
    c.config['general']['tabulated_gravity_file'] = '/path/to/gravity.profile'
    c.config['general']['tabulated_cross_section_file'] = '/path/to/cross.profile'
    config = f"""Initial_Conditions/profiles/initial.amr
...
#define MAX_VARIATION 1.1"""
    ...
    c.config['initial_conditions']['use_tabulated_gravity'] = True
    c.config['general']['tabulated_gravity_file'] = '/path/to/gravity.profile'
    header = f"""// ****
// *
// * #defines for configuring the hydrostatic model

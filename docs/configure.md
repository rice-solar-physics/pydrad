...
The next step is to pass it to the `pydrad` class which can parse it and print the needed configuration files,
...
An example default configuration file can be found in the root of the [pydrad repository](https://github.com/wtbarnes/pydrad).
